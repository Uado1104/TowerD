...
export class EasyControllerEvent {
   ...
   */
  public static CAMERA_ROTATE = 'EasyControllerEvent.CAMERA_ROTATE';

  /**
   * Dispatched when camera zooming
   * @params delta: amount of camera zoom
   */
  public static CAMERA_ZOOM = 'EasyControllerEvent.CAMERA_ZOOM';
  /**
   ...
   */
  public static MOVEMENT = 'EasyControllerEvent.MOVEMENT';
  /**
   * Dispatched when the movement controller stops moving
   */
  public static MOVEMENT_STOP = 'EasyControllerEvent.MOVEMENT_STOP';

  /**
   * Dispatched when one of the buttons is pressed.
   * @param buttonName: string, indicates which button is pressed.
   */
  public static BUTTON = 'EasyControllerEvent.BUTTON';

  /**
   * Dispatched when screen is touched.
   */
  public static SCREEN_TOUCH_START = 'EasyControllerEvent.SCREEN_TOUCH_START';

  /**
   * Dispatched when screen is touched end.
   */
  public static SCREEN_TOUCH_END = 'EasyControllerEvent.SCREEN_TOUCH_END';
}
