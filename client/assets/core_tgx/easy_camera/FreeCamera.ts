...
export class FreeCamera extends Component {
  ...
  updateDirection() {
    if (this.key2dirMap == null) {
      ...
      this.key2dirMap[KeyCode.KEY_A * 1000 + KeyCode.KEY_W] = this.key2dirMap[KeyCode.KEY_W * 1000 + KeyCode.KEY_A] =
        v2(-1, 1);
      this.key2dirMap[KeyCode.KEY_D * 1000 + KeyCode.KEY_W] = this.key2dirMap[KeyCode.KEY_W * 1000 + KeyCode.KEY_D] =
        v2(1, 1);
      this.key2dirMap[KeyCode.KEY_A * 1000 + KeyCode.KEY_S] = this.key2dirMap[KeyCode.KEY_S * 1000 + KeyCode.KEY_A] =
        v2(-1, -1);
      this.key2dirMap[KeyCode.KEY_D * 1000 + KeyCode.KEY_S] = this.key2dirMap[KeyCode.KEY_S * 1000 + KeyCode.KEY_D] =
        v2(1, -1);
    ...
    const keyCode0 = this.keys[this.keys.length - 1] || 0;
    const keyCode1 = this.keys[this.keys.length - 2] || 0;
    const dir = this.key2dirMap[keyCode1 * 1000 + keyCode0];
